...
(async () => {
    ...
    const samples = [
        ['resilient', 'Able to recover after difficulty.', 'Personal growth'],
        ['biodiversity', 'The variety of living species.', 'Environment'],
        ['hypothesis', 'An explanation that can be tested.', 'Science'],
        ['make progress', 'To move closer to a goal.', 'Everyday expressions'],
        ['sustainable', 'Able to continue without exhausting resources.', 'Environment'],
        ['perspective', 'A particular way of viewing a situation.', 'Personal growth'],
        ['innovation', 'A useful new idea, method, or product.', 'Technology'],
        ['curriculum', 'The subjects included in a course of study.', 'Education'],
        ['metaphor', 'An expression comparing unlike things.', 'Literature'],
        ['cognition', 'The mental process of understanding.', 'Psychology'],
        ['sediment', 'Material deposited by water or wind.', 'Geology'],
        ['revenue', 'Income received from business activity.', 'Business'],
        ['habitat', 'The natural home of a living thing.', 'Environment'],
        ['interpretation', 'An explanation of what something means.', 'Humanities'],
        ['conservation', 'Protection of natural resources.', 'Environment'],
    ];
